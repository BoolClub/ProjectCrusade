...
namespace DigitalRuby.RainMaker
{
    public class RainScript2D : BaseRainScript
    {
        ...
        protected override void Update()
        {
			...
			/* I commented these out because I don't want the rain to collide with anything. I just want it
			to fall straight down. It was having problems before when the player moved to the edges of the screen.*/
